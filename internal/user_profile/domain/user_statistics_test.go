...
func TestNewUserStatistics(t *testing.T) {
	...
	us := NewUserStatistics(accountID)
	...
	createdEvent, ok := events[0].(*UserStatisticsCreated)
	require.True(t, ok)
...
func TestRecordActivityJoined(t *testing.T) {
	...
	ev, ok := events[1].(*UserStatisticsActivityJoined)
	require.True(t, ok)
...
func TestRecordActivityCreated(t *testing.T) {
	...
	ev, ok := events[1].(*UserStatisticsActivityCreated)
	require.True(t, ok)
	assert.Equal(t, accountID, ev.AccountID)
...
func TestRecordActivityCompleted(t *testing.T) {
	...
	ev, ok := events[1].(*UserStatisticsActivityCompleted)
	require.True(t, ok)
	assert.Equal(t, accountID, ev.AccountID)
...
func Test_UserStatistics_ClearEvents(t *testing.T) {
	us := NewUserStatistics(uuid.New())
