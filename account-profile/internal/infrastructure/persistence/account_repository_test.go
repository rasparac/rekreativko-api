...
func Test_buildSingleProfileWhereQuery(t *testing.T) {
	...
	testCase := []struct {
		...
		},
		{
			...
			expectedQuery: "upp.account_id = $1 AND upp.deleted_at IS NULL",
		...
		},
		{
			...
			expectedQuery: "upp.account_id = $1 AND upp.nickname = $2 AND upp.deleted_at IS NULL",
...
func Test_buildMulitpleProfilesWhereQuery(t *testing.T) {
	...
	testCase := []struct {
	...
	}{
		{
			...
			expectedQuery: "upp.account_id IN ($1, $2)",
		...
		},
		{
			...
			expectedQuery: "upp.account_id IN ($1, $2) AND upp.nickname IN ($3, $4)",
